...
| --- | --- |
| Identity | [P01 Zero trust access](P01-zero-trust-access.md), [P03 Tiered privileged access](P03-tiered-privileged-access.md), [P10 Security telemetry and detection pipeline](P10-detection-telemetry.md) |
